...
import com.sitech.crmpd.idmm.client.exception.NoSuchPropertyException;
...
public class Message extends JSONSerializable implements Serializable {
	...
	public String getPropertiesAsString() {
		return JSON.toJSONString(properties, SERIALIZER_FEATURES);
	}
	...
	public String getSystemPropertiesAsString() {
		return JSON.toJSONString(systemProperties, SERIALIZER_FEATURES);
	}
	...
	public String toRestfulString() {
		...
		return JSON.toJSONString(jsonObject, SERIALIZER_FEATURES);
	}
